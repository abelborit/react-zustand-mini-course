...
export const JiraPage = () => {
  /* aquí se está haciendo con -- "zustand": "^4.5.5" -- pero lo de abajo funciona correctamente con -- "zustand": "^5.0.0-rc.2" -- pero con ese release canditate hay otros problemas al momento de actualizar el estado en JiraTasks.tsx por eso se está usando la última versión estable de zustand@4 */
  ...
  /* ************************************************************************************************************** */
  /* aquí se está haciendo con -- "zustand": "^5.0.0-rc.2" -- pero lo primero funciona correctamente con -- "zustand": "^4.5.5" -- */
